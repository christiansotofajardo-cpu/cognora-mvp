...
function ReportExplorer() {
  ...
  return (
    <Page>
        ...
        <Card>
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              "Reencuadre adaptativo",
              "Modulación colaborativa",
              "Coherencia discursiva",
            ].map((e) => (
              <div key={e} className="rounded-2xl bg-slate-50 p-5">
                <p className="text-lg text-slate-600">{e}</p>
                <p className="mt-2 text-2xl font-bold text-slate-950">Alta</p>
              </div>
            ))}
          </div>

          <blockquote className="mt-7 border-l-2 border-[#102033] pl-5 text-lg leading-relaxed text-slate-700">
      ...
      <section className="mt-7 grid grid-cols-2 gap-7">
        <Card>
          <div className="mb-6 flex items-center gap-3 text-3xl font-bold text-slate-950">
            <Target size={28} />
